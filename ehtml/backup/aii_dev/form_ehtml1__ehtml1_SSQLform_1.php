<?php
    ...
    $insert_col = "num_of_models,id,name,d";
    $notnullFlg = array(FALSE,TRUE,TRUE,TRUE);
    $checkboxFlg = array(FALSE,FALSE,FALSE,FALSE);
    $col_num = 4;
    $table = 'stock_model';
	...
	if($insert_str == ""){
        ...
        $insert_sql = "INSERT INTO ".$table." (".$insert_col.") VALUES ($1,$2,$3,$4)";
