<?PHP
  ...
  function ssql_exec_base($query){
    ...
    $fileName = substr($associative_array[0]["file"], strrpos($associative_array[0]["file"], "/") + 1);
...
//      }
  ...
  // cssの名前
  function setOutFileName($associative_array){
