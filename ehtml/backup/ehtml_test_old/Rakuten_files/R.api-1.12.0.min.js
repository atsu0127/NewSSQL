if(Rmodules && typeof Rmodules.define === 'function') { Rmodules.define('R.api', '1.12.0', ['R^1'], [], function(R, undefined) {
/*
 R.api-1.12.0.js
 Copyright (c) 2019 Rakuten.Inc
 Date: 2019-10-17 13:22:28
*/
...
},a.api.spu.SpuSection.prototype.removeService=function(b){for(var d,e=a.find(this.services,c(b));-1!==e;)d=this.services[e],d.isQualified&&(this.totalRate-=d.rate,this.parent&&(this.parent.totalRate-=d.rate)),this.services.splice(e,1),e=a.find(this.services,c(b))},a.api.spu.SpuSectionService=function(a){var b=a.spuxCampaignId?a.spuxCampaignId.toLowerCase():"";o[b]=a.spuxCampaignId,this.id=b,this.name=a.subtitle?a.subtitle["ja-JP"]:"",this.rate=parseFloat(a.rate),this.isQualified=a.qualified,this.link=a.link,
this.description=a.description?a.description["ja-JP"]:"",this.icon=a.iconSvg||a.icon,this.statusIcon=a.statusIconSvg||a.statusIcon,this.upperLimit=a.upperLimit,this.duration=a.duration},a.api.spu.loadSpu=function(b){var c,n,o=d.Deferred(),p=d.extend({mock_id:"SPU",encoding:a.api.spu.EUC_JP,retry:3,cache:!0},b),q=0,r=a.cookies.get("Rz"),s=a.browser.userAgent;if(!p.sid)throw"required options.sid not set";if(!p.source)throw"required options.source not set";if(!p.viewType)throw"required options.viewType not set";
switch(p.sid){case a.api.ServiceIds.ICHIBA_TOP:c=e+f;break;case a.api.ServiceIds.ICHIBA_ITEM:c=e+g;break;case a.api.ServiceIds.ICHIBA_SEARCH:c=e+h;break;case a.api.ServiceIds.ICHIBA_EVENT:c=e+i;break;default:c=e+j}return-1!==s.indexOf(k)||-1!==s.indexOf(l)||-1!==s.indexOf(m)?q=3:"pc"===p.source?q=0:"sp"===p.source&&(q=2),n=a.extendApiSettings({url:c,type:"POST",dataType:"json",contentType:"text/plain",processData:!1,data:{user:{rz:r},device:{id:q},viewtype:{id:p.viewType},items:[]}},b),p.itemId&&p.shopId?n.data.items.push({
itemId:p.itemId,shopId:p.shopId}):p.shopId&&(n.data.shop={id:p.shopId}),n.data=window.JSON.stringify(n.data),a.requestData(n).fail(o.reject).done(function(b){return b&&b.result?void o.resolve(new a.api.spu.ResponseData(b.result)):void o.reject()}),o.promise()},a.api.spu.getOriginalSectionId=function(a){return n[a.toLowerCase()]},a.api.spu.getOriginalServiceId=function(a){return o[a.toLowerCase()]}}(R),function(a,b){"use strict";var c=a.$,d="https://api.ranking.rakuten.co.jp/deliver/api/deliver/";a.api.itemRanking={
Encoding:{UTF_8:1,EUC_JP:0},QueryType:{NORMAL_RANKING:1,COUPON:2,NO1_OF_EACH_GENRE:3,GENRE_TREE:5,RANKED_IN:6,BOOKS_RANKING:7,TAG_RANKING:8,TAG_TREE:9,KOBO:10,SUPER_SALE:11,RANKED_IN_ITEM_SEARCH:12,RANKING_GENRE_SEARCH:13,BOOKS_RANKING_GENRE:15},TargetPeriod:{DAILY:1,WEEKLY:2,MONTHLY:3,HALF_YEAR:4,YEARLY:5,REAL_TIME:6,EVENT:7,ASURAKU:8},SearchType:{PRODUCT:0,CATALOG:1},SalesType:{GENERAL:0,NORMAL_PURCHASE:1,MULTIPLE_PURCHASE:2},CalculationType:{AVERAGE:1,HIGH:2,QUANTITY:3,AMOUNT:4,PIECES:5},MobileFlag:{
OFF:0,ON:1}},a.api.itemRanking.ResponseData=function(b){this.getItems=function(){var c,d,e=b.items,f=e.length,g=[];for(d=0;f>d;d++)c=new a.Item(e[d]),g.push(c);return g},this.getQuery=function(){return b.query},this.getRankingId=function(){return b.rankingid}},a.api.itemRanking.loadRankingItems=function(b){var e,f=c.Deferred(),g=c.extend({mockId:"RANKING",retry:3,cache:!0,queryType:a.api.itemRanking.QueryType.NORMAL_RANKING,areaCode:"00"},b);if(!g.genreId)throw"Required options.genreId is not set.";
return e=a.extendApiSettings({url:d,data:{qt:g.queryType,pr:g.areaCode,gid:g.genreId,enc:g.encoding,event_rnk_id:g.eventRankingId,eid:g.eventId,du:g.targetPeriod,offset:g.offset,st:g.searchType,sl:g.salesType,rt:g.calculationType,mb:g.mobileFlag,len:g.itemNameLength,slen:g.shopNameLength}},b),a.requestData(e).fail(f.reject).done(function(b){return b?void("0"===b.code?f.resolve(new a.api.itemRanking.ResponseData(b)):f.reject(b)):void f.reject()}),f.promise()}}(R);
//# sourceMappingURL=R.api-1.12.0.min.js.map
return R.api; });}