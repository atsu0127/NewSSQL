...
!function(n,e){"use strict";var t="1.0.22",o="NOLBUNDLE",a=0,r={paramPrefix:"",maxRetries:5},s={defaultNSDKV:600,defaultSfcode:"sdk",subdomain:"cdn-gl",domain:"imrworldwide.com",protocol:0===n.location.protocol.indexOf("http:")?"http:":"https:",sdkUrl:"{{protocol}}//{{subdomain}}.{{domain}}/novms/js/{{sdksubpath}}/nlsSDK{{nsdkv}}.bundle.min.js"},i={eu:"600.eu","eu-cert":"600.eu","eu-uat":"600.eu"},l={parseNOLParams:function(n){var e=n.replace(/^[^\#]+\#?/,""),t={};if(!e)return t;var o=new RegExp("&"+r.paramPrefix,"gi"),a="<<nol_delimeter>>",s=a+r.paramPrefix;e=e.replace(o,s);for(var i=e.split(a),l=null,c=0;c<i.length;c++){l=i[c].indexOf("=");var u=unescape(i[c].substr(0,l)),d=unescape(i[c].substr(l+1));d=d.replace(/\+/g," "),t[u.replace(r.paramPrefix,"")]=d}return t},findScript:function(n){if(document.currentScript)return document.currentScript.src;console&&console.log&&(console.log("Config",new Date),console.log("Config",new Date));var e=document.getElementsByTagName("script"),t=[];if(e)for(var o=null,a="",r=null,s=new RegExp(n+".*?.js"),i=0;i<e.length;i++)r=e[i],a=r&&r.attributes&&r.attributes.src?r.attributes.src.value:"",(o=a.match(s))&&t.push(a);return t},loadScript:function(e,t,o){function a(e,t,o){var a=n.document.createElement("script");a.async=!0,a.setAttribute("data-jsonpid",name),a.src=e,a.onload=t,a.onerror=o;var r=n.document.getElementsByTagName("script")[0];r.parentNode.insertBefore(a,r)}function s(n){i<r.maxRetries?(i++,setTimeout(function(){console&&console.warn&&console.warn("Retry request # "+i),a(e,t,s)},2e3)):(console&&console.error&&console.error("Unable to load script "+e),o&&o())}var i=0;a(e,t,s)},setTesting:function(n){return n&&n.enableTesting&&e&&e.nol_GLOBALS&&s?("true"===n.enableTesting&&"true"===e.nol_GLOBALS.nol_allowTesting&&(n.sfcode="cert",s.subdomain="futuremaster.nonprod",s.domain="digitalengsdk.com"),n):n},getGlobalsField:function(e,t,o){if(t&&o&&n[e]&&n[e].configs){var a=n[e].configs[t];if(a&&a.nol_GLOBALS)return a.nol_GLOBALS[o]}return null},getDefaultField:function(e,t,o){if(t&&o&&n[e]&&n[e].configs){var a=n[e].configs[t];if(a&&a.nol_GLOBALS&&a.nol_GLOBALS.nol_tagMap&&a.nol_GLOBALS.nol_tagMap.nol_defaults)return a.nol_GLOBALS.nol_tagMap.nol_defaults[o]}return null}},c={setNamespace:function(e){return n[e]=n[e]||{nlsQ:function(t,o,a,r,s,i){return s=w.document,r=s.createElement("script"),r.async=1,r.src=("http:"===n.location.protocol?"http:":"https:")+"//cdn-gl.imrworldwide.com/conf/"+t+".js#name="+o+"&ns="+e,i=s.getElementsByTagName("script")[0],i.parentNode.insertBefore(r,i),w[o]=w[o]||{g:a,ggPM:function(n,e,t,a,r){(w[o].q=w[o].q||[]).push([n,e,t,a,r])}},w[o]}}},setConfig:function(n,e,t){t.configs=t.configs||{},t.configs[n]=t.configs[n]||e}},u={getInstanceGlobals:function(e,t,o){var a={apid:t,sfcode:l.getDefaultField("nol_sfcode")||s.defaultSfcode,nsdkv:s.defaultNSDKV},r=n[e][o.name]||n[o.name],c=r?r.g:{};if(c)for(var u=Object.keys(c),d=0;d<u.length;d++)void 0!==c[u[d]]&&null!==c[u[d]]&&""!==c[u[d]]&&(a[u[d]]=c[u[d]]);a.sfcode=l.getGlobalsField(e,t,"nol_sfcode")||a.sfcode,a.nsdkv=l.getGlobalsField(e,t,"nol_nsdkvConfig")||l.getGlobalsField(e,t,"nol_nsdkv")||i[a.sfcode]||a.nsdkv,a=l.setTesting(a);var f=l.getGlobalsField(e,t,"nol_sdkDebug");return f&&(a.nol_sdkDebug=f),a},isSDKReady:function(e){var t=n[e];return t&&t.hasOwnProperty("isBuilt")&&"function"==typeof t.isBuilt&&t.isBuilt()},loadSDK:function(e,t,o,a){try{var r=u.getInstanceGlobals(a,t,o),i=function(){try{if(e&&o&&o.name){var t=n[a].getInstance(o.name,!0);t&&!t.initialized&&t.ggInitialize(r)}}catch(n){}};if(u.isSDKReady(a))i();else{var c=(r&&r.sdkUrl?r.sdkUrl:s.sdkUrl).replace("{{protocol}}",s.protocol).replace("{{subdomain}}",o&&o.subdomain?o.subdomain:r&&r.subdomain?r.subdomain:s.subdomain).replace("{{domain}}",o&&o.domain?o.domain:r&&r.domain?r.domain:s.domain).replace("{{sdksubpath}}","NOLSDKBUNDLE"===a?"nolsdk":"2").replace("{{nsdkv}}",r.nsdkv);l.loadScript(c,i)}}catch(n){}},iterateInstances:function(n,e){if(e){var t=l.findScript(n);if("string"==typeof t)e(n,l.parseNOLParams(t));else for(var o=0;o<t.length;o++)e(n,l.parseNOLParams(t[o]))}}},d=e&&e.nol_GLOBALS?e.nol_GLOBALS.nol_appid:"";try{d?u.iterateInstances(d,function(t,a){var r=a&&a.ns?n[a.ns][a.name]:null;if(r||(r=a&&a.ns?n[a.name]:null),r&&!r.initialized){var s=c.setNamespace(a&&a.ns?a.ns:o);c.setConfig(t,e,s),u.loadSDK(s,t,a,a&&a.ns?a.ns:o)}}):console&&console.warn&&console.warn("Nielsen Log: Client config structure is invalid or corrupt.")}catch(n){}}(
    window,
	{
		"nol_GLOBALS":{
            ...
            "nol_osGroup":"",
            "nol_platform":"",
			"nol_clientid":"jp-910517","nol_vcid":"c01","nol_clientCMSmap":{"nol_vidtype":"type","nol_assetid":"assetid","nol_category":"(program)","nol_adobeId":"adobeId","nol_crossRefID1":"crossId1","nol_crossRefID2":"crossId2","nol_adobeSessionId":"adobeVsid","nol_progen":"progen","nol_stationId":"stationId","nol_scheduledEndDate":"((scheduledEndDate))","nol_segmentC":"(segC)","nol_reportSuiteID":"(reportSuite)","nol_segmentA":"(segA)","nol_assetName":"(section)","nol_stationType":"stationType","nol_segmentB":"(segB)","nol_clientid":"clientid","nol_vcid":"subbrand"},"nol_sfcode":"dcr",
